  ...
  return (
    <div className="w-full  ">
      ...
      <div>
        ...
        <div className="flex border-2 border-gray-100 items-center h-[50px] bg-gradient-to-r from-[#819cff43] rounded-[10px] to-[#10101000]   ">
          <div className="ms-4 text-lg text-[#7E96FF]">
            <GoAlert />
          </div>
          <div>
            <p className="text-sm mx-4">
              <p className="m-0 p-0"> You've burned fewer calories than</p>{" "}
              <p className="m-0 p-0"> yesterday. Time to get moving! </p>
            </p>
          </div>
        </div>
        <WorkoutCard />
        ...
        <label htmlFor="toggle" className={labelClasses}>
          <div className="relative">
            <label class="inline-flex items-center cursor-pointer">
              ...
              <div class="relative w-10 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[3px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all  peer-checked:bg-blue-600"></div>
            </label>
          </div>
        </label>
      </div>
